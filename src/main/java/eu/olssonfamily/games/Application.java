...
//			repository.save(new Customer("Michelle", "Dessler"));
			...
			// fetch High score list
			log.info("High score list found with findAll():");
			log.info("----------------s---------------");
			for (HighScore playerScore : repository.findAll()) {
				log.info(playerScore.toString() + "\n");
			}
			log.info("");
//
